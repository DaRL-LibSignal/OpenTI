...
def click_simulate(path=""):
    ...
    working_dir = "/home/local/ASURITE/longchao/Desktop/project/LLM4Traffic/OpenTI/pivotalAgent/AugmentUtils/one_click_SUMO/autoSimuOutput/"+curr_time+"/"
    os.makedirs(working_dir)
    save_path = working_dir + "images/"
    os.makedirs(save_path)

    working_dir = "/home/local/ASURITE/longchao/Desktop/project/LLM4Traffic/OpenTI/pivotalAgent/AugmentUtils/one_click_SUMO/autoSimuOutput/" + curr_time + "/"
    sumo_path =  yaml.load(open('/home/local/ASURITE/longchao/Desktop/project/LLM4Traffic/OpenTI/pivotalAgent/Configs/path.yaml'), Loader=yaml.FullLoader)['SUMO_PATH']
    ...
    cd {working_dir}
    cp {path} ./
    netconvert --osm-files {file_name} -o map.net.xml
    ...
    echo $PWD
    cp /home/local/ASURITE/longchao/Desktop/project/LLM4Traffic/OpenTI/pivotalAgent/AugmentUtils/one_click_SUMO/base.sumocfg ./
